...
export const zhCN: Dict = {
  ...
  'pluginDetails.viewDetailsAria': '查看 {title} 的详情',
  'pluginDetails.chooseUseAria': '选择如何使用 {title}',
  'pluginDetails.useOptionsAria': '{title} 的使用选项',
  'pluginDetails.shareAria': '分享 {title}',
  'pluginDetails.publishGithubAria': '将 {title} 发布为 GitHub 仓库',
  'pluginDetails.contributeOpenDesignAria': '将 {title} 贡献到 Open Design',
  'pluginDetails.publishGithub': '将插件发布为 GitHub 仓库',
  'pluginDetails.contributeOpenDesign': '通过拉取请求贡献到 Open Design',
  'pluginDetails.usePlugin': '使用',
  'pluginDetails.useWithQuery': '连同查询使用',
  'pluginDetails.publish': '发布',
  'pluginDetails.contribute': '贡献',
  'pluginDetails.starting': '正在开始…',
  'pluginDetails.pluginInfo': '插件信息',

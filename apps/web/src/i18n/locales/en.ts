...
export const en: Dict = {
  ...
  'pluginDetails.viewDetailsAria': 'View details for {title}',
  'pluginDetails.chooseUseAria': 'Choose how to use {title}',
  'pluginDetails.useOptionsAria': 'Use options for {title}',
  'pluginDetails.shareAria': 'Share {title}',
  'pluginDetails.publishGithubAria': 'Publish {title} as a GitHub repository',
  'pluginDetails.contributeOpenDesignAria': 'Contribute {title} to Open Design',
  'pluginDetails.publishGithub': 'Publish plugin as a GitHub repository',
  'pluginDetails.contributeOpenDesign': 'Contribute plugin to Open Design with a pull request',
  'pluginDetails.usePlugin': 'Use',
  'pluginDetails.useWithQuery': 'Use with query',
  'pluginDetails.publish': 'Publish',
  'pluginDetails.contribute': 'Contribute',
  'pluginDetails.starting': 'Starting…',
  'pluginDetails.pluginInfo': 'Plugin info',
